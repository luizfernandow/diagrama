...
class ProjectController extends Controller
{
    ...
    public function create()
    {
        ...
        $journals = $journals->get()->pluck('title', 'id')->filter()->toArray() + ['' => ''];
        $articleTypes = Project::$articleTypes + ['' => ''];
        
        return view('project.create', compact('journals', 'articleTypes'));
    }
    ...
    public function edit(Project $project)
    {
        ...
        return view('project.edit', compact('journals', 'project', 'articleTypes'));
    }
    ...
    /**
     * Download a XML for a project.
     *
     * @param  \App\Project  $project
     * @return \Illuminate\Http\Response
     */
    public function xml(Project $project)
    {
        ...
        $array = [
            'front' => [
                'journal-meta' => [
                    'journal-id' => [
                        ['_attributes' => ['journal-id-type' => 'nlm-ta'], '_value' => $journal->short_title_nlm],
                        ['_attributes' => ['journal-id-type' => 'publisher-id'], '_value' => $journal->acronym]
                    ],
                    'journal-title-group' => [
                        'journal-title' => $journal->title,
                        'abbrev-journal-title' => [
                            '_attributes' => ['abbrev-type' => 'publisher'],
                            '_value' => $journal->short_title
                        ]
                    ],
                    'issn' => [
                        ['_attributes' => ['pub-type' => 'ppub'], '_value' => $journal->issn],
                        ['_attributes' => ['pub-type' => 'epub'], '_value' => $journal->e_issn]
                    ],
                    'publisher' => [
        ...
        $root = [
            ...
            '_attributes' => [
                'article-type' => $project->article_type,
                'dtd-version' => '1.0',
        ...
        return response($domDocument->saveXML(), 200)
                      ...
                      ->header('Content-Disposition', "attachment; filename=$project->name.xml");
    }
}
